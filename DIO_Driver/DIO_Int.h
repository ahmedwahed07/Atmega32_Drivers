...
/*Port no{PORTA_Reg,PORTB_Reg,PORTC_Reg,PORTD_Reg}*/
/*Direction {FULL OUTPUT,FULL INPUT} */
/*default PORTA Output */
void DIO_vidSetPortDirection(u8 port_no,u8 port_direction);

/*Port no{PORTA_Reg,PORTB_Reg,PORTC_Reg,PORTD_Reg}*/
/*Pin no {PIN0,PIN1,PIN2,PIN3,PIN4,PIN5,PIN6,PIN7}*/
/*pin direction {OUTPUT, INPUT}*/
/*default PORTA0 Input*/
void DIO_vidSetPinDirection(u8 port_no,u8 pin_no,u8 pin_diection);

/*Port no{PORTA_Reg,PORTB_Reg,PORTC_Reg,PORTD_Reg}*/
/*Port value {FULL HIGH,FULL LOW}*/
/*default PORTA=0xff*/
